package com.hillel.FirstCourse.homework.lesson4;
...
public class shelter {
    ...
    public static void main(String[] agrs) throws IOException {
        ...
        int eatingCats = shelterMethods.eatingCats(cat, gramme, dayInMonth, nutrition);
        int eatingDogs = shelterMethods.eatingdogs(dog, gramme, dayInMonth, nutrition);
        int mustBeManey = shelterMethods.mastBeManey(eatingCats, eatingDogs,gramme, money);
